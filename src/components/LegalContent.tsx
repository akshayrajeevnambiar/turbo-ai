export const PrivacyPolicyContent = () => (
  <div className="prose prose-invert max-w-none space-y-6">
    ...
    <section>
      ...
      <p className="text-white/80 leading-relaxed mb-3 text-sm">
        Turbo AI is a technology and AI research company based in Calgary, Alberta, Canada, focusing on AI infrastructure, software development, drone intelligence, and industrial automation.
    ...
    <section>
      ...
      <p className="text-white/80 leading-relaxed mb-3 text-sm">This Policy applies to:</p>
    ...
    <section>
      ...
      <h3 className="text-lg font-semibold mb-2 text-blue-400">a) Personal Information</h3>
      ...
      <h3 className="text-lg font-semibold mb-2 text-blue-400">b) Technical Information</h3>
      <ul className="list-disc list-inside text-white/80 space-y-1 text-sm mb-3">
      ...
      <h3 className="text-lg font-semibold mb-2 text-blue-400">c) Operational Data</h3>
      ...
      <h3 className="text-lg font-semibold mb-2 text-blue-400">d) Payment Information</h3>
    ...
    <section>
      ...
      <p className="text-white/80 leading-relaxed mb-3 text-sm">We use collected data to:</p>
      <ul className="list-disc list-inside text-white/80 space-y-1 text-sm mb-3">
    ...
    <section>
      ...
      <p className="text-white/80 leading-relaxed mb-3 text-sm">Turbo AI may share limited information with:</p>
      <ul className="list-disc list-inside text-white/80 space-y-1 text-sm mb-3">
    ...
    <section>
      <h2 className="text-xl font-semibold mb-3 text-white">7. Data Storage, Transfers, and Retention</h2>
      <p className="text-white/80 leading-relaxed mb-3 text-sm">
    ...
    <section>
      ...
      <p className="text-white/80 leading-relaxed mb-3 text-sm">We employ industry-grade protections:</p>
      <ul className="list-disc list-inside text-white/80 space-y-1 text-sm mb-3">
    ...
    <section>
      ...
      <p className="text-white/80 leading-relaxed mb-3 text-sm">Depending on your jurisdiction, you have the right to:</p>
      <ul className="list-disc list-inside text-white/80 space-y-1 text-sm mb-3">
    ...
    <section>
      <h2 className="text-xl font-semibold mb-3 text-white">11. Changes to this Policy</h2>
      <p className="text-white/80 leading-relaxed text-sm">
